        ...
        return (
            <>
                <div className="card col-4 ">
                    <img className="capa" src={data.capa} alt="" />
                    ...
                    <div className="content">
                        ...
                        <span className="logo-bottom-text text-danger">{data.resumo}</span>
                    </div>
                    <span className="bottom-text text-danger">{data.tipo}</span>
                </div>
            </>
